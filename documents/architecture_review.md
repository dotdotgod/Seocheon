...
> 대상 문서: `documents/blockchain/` (14개 문서), `documents/sdk/` (8개 문서), `documents/agent_architecture.md`, `documents/mcp_server_architecture.md`, `documents/foundation_strategy.md`
...
| 스케일링 전략 | 중 | ✅ 문서화 완료 ([14_scaling_strategy.md](blockchain/14_scaling_strategy.md)) — 병목 분석 + Phase별 대응 |
