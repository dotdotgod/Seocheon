...
> **담당**: 체인 코어 개발자 / DevOps
> **관련 문서**: [개요](01_overview.md) · [노드 모듈](03_node_module.md) · [Activity Protocol](04_activity_protocol.md) · [구현 가이드](07_implementation.md) · [재단 전략](../foundation_strategy.md) · [Circuit Breaker](09_circuit_breaker.md) · [전체 목차](README.md)
