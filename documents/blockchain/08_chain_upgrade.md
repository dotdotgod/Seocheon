...
> **담당**: 체인 코어 개발자 / DevOps
> **관련 문서**: [개요](01_overview.md) · [노드 모듈](03_node_module.md) · [Activity Protocol](04_activity_protocol.md) · [구현 가이드](07_implementation.md) · [빌더 전략](../foundation_strategy.md) · [Circuit Breaker](09_circuit_breaker.md) · [전체 목차](README.md)
...
상세 플로우:
  [1] 빌더 또는 커뮤니티가 SoftwareUpgradeProposal 제출
...
시나리오 1: ActivityRecord 스키마 변경
  ...
  마이그레이션:
  ├── 프루닝 보존 기간 내 활동 기록만 대상 (최근 6,307,200 블록)
...
긴급 거버넌스 플로우:
  [1] 보안 취약점 발견 → 비공개 채널로 빌더에 통보

  [2] 빌더가 ExpeditedProposal 제출
