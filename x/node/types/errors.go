...
var (
	...
	ErrNotInRenewalWindow         = errors.Register(ModuleName, 1120, "not in renewal window")
	ErrAlreadyExpired             = errors.Register(ModuleName, 1121, "delegation already expired")
	ErrActiveDelegationDisabled   = errors.Register(ModuleName, 1122, "active delegation is disabled")
)
