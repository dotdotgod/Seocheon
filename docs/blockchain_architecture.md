...
| 06 | [Node Directory Protocol](blockchain/06_directory_protocol.md) | CosmWasm 개발자 (Rust) | 서비스 디스커버리, 인터페이스 등록 |
...
| 11 | [Circuit Breaker](blockchain/11_circuit_breaker.md) | 체인 코어 / 보안 | 긴급 정지 메커니즘, 자동/수동 트리거, 복구 절차 |
| 12 | [IBC 전략](blockchain/12_ibc_strategy.md) | 인프라 / 네트워크 | IBC Transfer, 크로스체인 Activity |
